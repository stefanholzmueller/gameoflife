...
(function(exports) {
  ...
  var neighbors = function (v) {
      ...
      return Data_Functor.map(Data_Functor.functorArray)(function (d) {
          return cell(d.dx + v.value0.x | 0)(d.dy + v.value0.y | 0);
      })(directions);
  };
  var tick = function (neighborsFn) {
      return function (survivePred) {
          return function (reproducePred) {
              return function (livingCells) {
                  var neighboringDeadCells = Data_Array.difference(eqCell)(Data_Array.nub(eqCell)(Control_Bind.bind(Control_Bind.bindArray)(livingCells)(neighbors)))(livingCells);
                  var livingNeighborsCount = function (c) {
                      return Data_Array.length(Data_Array.intersect(eqCell)(neighbors(c))(livingCells));
                  };
                  var offspring = Data_Array.filter(function ($16) {
                      return reproducePred(livingNeighborsCount($16));
                  })(neighboringDeadCells);
                  var survivors = Data_Array.filter(function ($17) {
                      return survivePred(livingNeighborsCount($17));
                  })(livingCells);
                  return Data_Array.union(eqCell)(survivors)(offspring);
              };
          };
      };
  };
  var tick$prime = tick(neighbors)(function (n) {
      return n === 2 || n === 3;
  })(function (v) {
      return v === 3;
  });
...
(function(exports) {
  ...
  var ui = (function () {
      var render = function (state) {
          ...
          return Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderCell)(state.cells));
      };
      var $$eval = function (v) {
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.modify(function (state) {
              return {
                  cells: Life["tick'"](state.cells)
              };
          }))(function () {
  ...
  var initialState = {
      cells: [ Life.cell(2)(1), Life.cell(3)(2), Life.cell(3)(3), Life.cell(2)(3), Life.cell(1)(3), Life.cell(11)(2), Life.cell(12)(2), Life.cell(13)(2), Life.cell(2)(11), Life.cell(3)(11), Life.cell(2)(12), Life.cell(3)(12), Life.cell(31)(20), Life.cell(32)(20), Life.cell(30)(21), Life.cell(31)(21), Life.cell(31)(22) ]
  };
