...
(function(exports) {
  ...
  var semigroupPrefixed = new Data_Semigroup.Semigroup(function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at CSS.Property line 29, column 3 - line 29, column 46: " + [ v.constructor.name, v1.constructor.name ]);
      };
  });
...
(function(exports) {
  ...
  var rule = function ($424) {
      return S(Control_Monad_Writer_Class.tell(Control_Monad_Writer_Trans.monadWriterWriterT(Data_Monoid.monoidArray)(Data_Identity.monadIdentity))(Data_Array.singleton($424)));
  };
  ...
  var bindStyleM = new Control_Bind.Bind(function () {
      ...
      return function (f) {
          return Data_Function.apply(S)(Control_Bind.bind(Control_Monad_Writer_Trans.bindWriterT(Data_Semigroup.semigroupArray)(Data_Identity.monadIdentity))(v)(function ($428) {
              return (function (v1) {
                  return v1;
              })(f($428));
          }));
  ...
  var collect$prime = function (v) {
      return function (v1) {
          ...
          if (v instanceof CSS_Property.Prefixed && v1 instanceof CSS_Property.Prefixed) {
              return Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                  return Data_Function.apply(Data_Maybe.maybe(new Data_Either.Left(v2.value0 + v2.value1))(function ($192) {
...
(function(exports) {
  ...
  exports["style"] = style;
})(PS["Halogen.HTML.CSS.Indexed"] = PS["Halogen.HTML.CSS.Indexed"] || {});
(function(exports) {
  // Generated by psc version 0.9.3
  "use strict";
  var Prelude = PS["Prelude"];
...
(function(exports) {
  ...
  var Dead = (function () {
      function Dead(value0) {
          this.value0 = value0;
      };
      Dead.create = function (value0) {
          return new Dead(value0);
      };
      return Dead;
  })();
  var Zombie = (function () {
  ...
  var stateChange = function (v) {
      return function (n) {
          if (v instanceof Alive) {
              if (n === 2 || n === 3) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Alive.value);
              };
              if (Data_Boolean.otherwise) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Dead(0));
              };
          };
          if (v instanceof Dead) {
              if (v.value0 === 1) {
                  return Data_Functor.map(Control_Monad_Eff.functorEff)(function (r) {
                      var $19 = r < 0.3;
                      if ($19) {
                          return Zombie.value;
                      };
                      if (!$19) {
                          return new Dead(v.value0 + 1 | 0);
                      };
                      throw new Error("Failed pattern match at Life line 78, column 54 - line 78, column 96: " + [ $19.constructor.name ]);
                  })(Control_Monad_Eff_Random.randomRange(0.0)(1.0));
              };
              if (n === 3) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Alive.value);
              };
              if (Data_Boolean.otherwise) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Dead(v.value0 + 1 | 0));
              };
          };
          if (v instanceof Zombie) {
              ...
              if (Data_Boolean.otherwise) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Zombie.value);
              };
          };
          throw new Error("Failed pattern match at Life line 76, column 1 - line 77, column 56: " + [ v.constructor.name, n.constructor.name ]);
      };
  }; 
  var neighbors = function (v) {
      var deltas = [ -1, 0, 1 ];
      var directions = Control_Bind.bind(Control_Bind.bindArray)(deltas)(function (v1) {
          return Control_Bind.bind(Control_Bind.bindArray)(deltas)(function (v2) {
              return Control_Bind.bind(Control_Bind.bindArray)(Data_Function.apply(Control_MonadZero.guard(Control_MonadZero.monadZeroArray))(!(v1 === 0 && v2 === 0)))(function () {
  ...
  var isAlive = function (v) {
      if (v.value1 instanceof Alive) {
          return true;
      };
      return false;
  };
  var getCoords = function (v) {
      return v.value0;
  };
  var eqCoords = new Data_Eq.Eq(function (v) {
      return function (v1) {
          return v.x === v1.x && v.y === v1.y;
      };
  });
  var nextGen = function (neighborsConfig) {
      return function (stateChangeConfig) {
          return function (population) {
              var populationCoords = Data_Functor.map(Data_Functor.functorArray)(getCoords)(population);
              var neighboringCoords = Data_Array.difference(eqCoords)(Data_Array.nub(eqCoords)(Control_Bind.bind(Control_Bind.bindArray)(populationCoords)(neighbors)))(populationCoords);
              var coordsOfAliveCells = Data_Functor.map(Data_Functor.functorArray)(getCoords)(Data_Array.filter(isAlive)(population));
              var numberOfAliveNeighbors = function (coords) {
                  return Data_Array.length(Data_Array.intersect(eqCoords)(coordsOfAliveCells)(neighbors(coords)));
              };
              var nextState = function (v) {
                  return function __do() {
                      var v1 = stateChangeConfig(v.value1)(numberOfAliveNeighbors(v.value0))();
                      return new Cell(v.value0, v1);
                  };
              };
              var nextStateInNeighboringCoords = function (coords) {
                  return nextState(new Cell(coords, new Dead(0)));
              };
              return function __do() {
                  var v = Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(nextState)(population)();
                  var v1 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_Eff.applicativeEff)(nextStateInNeighboringCoords)(neighboringCoords)();
                  var newAliveCells = Data_Array.filter(isAlive)(v1);
                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)(v)(newAliveCells);
              };
          };
      };
  };
  var gameOfLife = nextGen(neighbors)(stateChange);
  exports["Cell"] = Cell;
  exports["Alive"] = Alive;
  exports["Dead"] = Dead;
...
(function(exports) {
  ...
  var Halogen_HTML_CSS_Indexed = PS["Halogen.HTML.CSS.Indexed"];
  var Halogen_HTML_Core = PS["Halogen.HTML.Core"];
  ...
  var toString = function (v) {
      if (v instanceof Life.Alive) {
          return "alive";
      };
      if (v instanceof Life.Dead) {
          return "dead";
      };
      if (v instanceof Life.Zombie) {
          return "zombie";
      };
      throw new Error("Failed pattern match at Main line 26, column 1 - line 27, column 1: " + [ v.constructor.name ]);
  };
  var ui = (function () {
      var render = function (state) {
          var renderCell = function (v) {
              return Halogen_HTML_Elements_Indexed.div([ Data_Function.apply(Halogen_HTML_Properties_Indexed.class_)(Data_Function.apply(Halogen_HTML_Core.className)(toString(v.value1))), Halogen_HTML_CSS_Indexed.style(Control_Bind.bind(CSS_Stylesheet.bindStyleM)(Data_Function.apply(CSS_Geometry.left)(Data_Function.apply(CSS_Size.px)(Data_Function.apply(Data_Int.toNumber)(32 * v.value0.x | 0))))(function () {
                  return Data_Function.apply(CSS_Geometry.top)(Data_Function.apply(CSS_Size.px)(Data_Function.apply(Data_Int.toNumber)(32 * v.value0.y | 0)));
              })) ])([  ]);
          };
          return Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderCell)(state));
      };
      var $$eval = function (v) {
          return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.get)(function (v1) {
              var s = Control_Monad_Eff_Unsafe.unsafePerformEff(Life.gameOfLife(v1));
              return Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.set(s))(function () {
  ...
  var initialState = [ cell(2)(1), cell(3)(2), cell(3)(3), cell(2)(3), cell(1)(3), cell(11)(2), cell(12)(2), cell(13)(2), cell(2)(11), cell(3)(11), cell(2)(12), cell(3)(12), cell(31)(20), cell(32)(20), cell(30)(21), cell(31)(21), cell(31)(22) ];
  var main = Halogen_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Driver.runUI(ui)(initialState)(v))(function (v1) {
          return Data_Function.apply(setInterval(1000))(v1(Halogen_Query.action(Tick.create)));
      });
  }));
  exports["Tick"] = Tick;
  exports["cell"] = cell;
